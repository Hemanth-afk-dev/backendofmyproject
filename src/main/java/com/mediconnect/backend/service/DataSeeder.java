...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        inventoryItemRepository.save(createInventory("Paracetamol 500mg", "Pain Relief", 500, 100, "5.99", "tablets", "PharmaCorp", LocalDate.of(2027, 6, 15)));
        inventoryItemRepository.save(createInventory("Cetirizine 10mg", "Antihistamine", 200, 50, "8.99", "tablets", "MediSupply", LocalDate.of(2027, 8, 20)));
        inventoryItemRepository.save(createInventory("Vitamin C 1000mg", "Supplements", 350, 75, "12.99", "tablets", "VitaHealth", LocalDate.of(2027, 12, 1)));
